/var/server_name = "Prison Station 13"
/var/game_id = null
/var/list/warfare_taglines = list("Pooping Simulator", "The Warden Is A Faggot", "Don't Drop The Soap", "Blood, Tears and Cuffs", "FuuuuuuuuuUUUUUUUUUUUUUUUUCK!", "Is This Even Real", "Grand Theft Prison")// list("It's Getting Cold Out There", "New Guns", "New Classes", "Cold", "Winter", "Frozen Solid", "Frozen Trench Pizza", "Warcrime Simulator", "Your Heart Has Stopped", )
